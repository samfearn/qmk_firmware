...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    FUNCT, KC_LCTL, KC_LALT, KC_LCMD, LOWER,   KC_SPC,  KC_SPC,  RAISE,   TD(TD_CMDALT), KC_LEFT, KC_DOWN,   KC_RGHT
),
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    LSFT_T(KC_LBRC), KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12, TD(TD_1P_KEY) , KC_SCLN, KC_SLSH, KC_VOLU,  RSFT_T(KC_RBRC),
...
[_RAISE] = LAYOUT_planck_grid(
    ...
    LSFT_T(KC_LBRC), KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_QUES, KC_COLN, KC_BSLS, KC_VOLU, RSFT_T(KC_RBRC),
    _______, _______, _______, _______, _______, _______, _______, _______, KC_MPLY, KC_MRWD, KC_VOLD, KC_MFFD
),
...
[_FUNCT] = LAYOUT_planck_grid(
   _______, _______, _______, _______, _______, KC_P7, KC_P8, KC_P9, KC_PAST,  KC_PSLS, _______, KC_DEL ,
   _______, _______, _______, _______, _______, KC_P4, KC_P5, KC_P6, KC_PPLS,  KC_PMNS, _______, _______ ,
   _______, _______, _______, _______, _______, KC_P1, KC_P2, KC_P3, KC_PCMM,  KC_PDOT, _______, _______ ,
   _______, _______, _______, _______, _______, KC_P0, KC_P0, KC_PENT, KC_PEQL,  _______, _______, _______
)
